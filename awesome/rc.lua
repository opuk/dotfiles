...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Mod1"    }, "l", function () os.execute("xscreensaver-command -lock") end),
    ...
    awful.key({ }, "XF86AudioLowerVolume", function () awful.util.spawn("amixer -q -c 0 sset Master 2dB-") end),
    awful.key({ }, "XF86AudioRaiseVolume", function () awful.util.spawn("amixer -q -c 0 sset Master 2dB+") end),
